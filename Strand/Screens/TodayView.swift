...
struct TodayView: View {
    ...
    /// baseline caption, the big white value, and a chevron, the whole row navigates to `route`,
    /// pushed by value (#198; see TabRoute.swift). Flat WHOOP styling (FrostedCardSurface, no
    /// glow), tokens only.
